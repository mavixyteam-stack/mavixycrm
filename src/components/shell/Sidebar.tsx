...
import { Sparkle, Calendar, BarChart, Building, Users, Book, Settings, Zap, FileText, Globe, LogOut, X } from '@/components/ui/Icon'
...
const NAV = [
  ...
  },
  {
    group: 'Sales',
    items: [
      { id:'journey', label:'Client Journey', Icon: () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="5" cy="6" r="2"/><circle cx="19" cy="18" r="2"/><path d="M7 6h6a4 4 0 0 1 0 8H9a4 4 0 0 0 0 8h0"/><path d="M17 18h-2"/></svg> },
      { id:'invoices', label:'Invoices', Icon: () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M6 2h9l3 3v17l-3-2-2 2-2-2-2 2-2-2-2 2V4a2 2 0 0 1 2-2z"/><path d="M9 8h6M9 12h6M9 16h4"/></svg> },
    ]
  },
  {
    group: 'Org',
