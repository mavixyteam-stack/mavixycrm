...
const AUTOMATIONS: Automation[] = [
  ...
  {
    id: 'eod-logs',
    name: 'End-of-Day Log Reminder',
    description: 'At day\'s end, reminds anyone who worked but hasn\'t submitted their end-of-day update to check out and log what they got done.',
    trigger: 'Every day at 7:00 PM',
    action: 'In-app + Telegram + email nudge',
    recipients: 'Anyone missing a log',
    schedule: 'Daily, 7:00 PM',
    endpoint: '/api/automations/eod-logs',
  },
  {
    id: 'daily-report',
    name: 'AI Daily Report',
    description: 'Reads the day\'s checkout logs, attendance, and work, then writes an AI end-of-day report — progress by department and client, watch-outs, tomorrow\'s focus — and emails it to the owners.',
    trigger: 'Every day at 8:30 PM',
    action: 'AI report emailed to owners',
    recipients: 'Owner, Manager',
    schedule: 'Daily, 8:30 PM',
    endpoint: '/api/automations/daily-report',
  },
  {
    id: 'reminders',
